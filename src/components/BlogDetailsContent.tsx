...
function MediaExcerptRow({
    ...
    <div className="md:col-span-7 lg:col-span-7">
      <div className="relative w-full overflow-hidden rounded-[28px] rounded-tr-none bg-[#111]">
        <Image
          ...
          preload={index === 0}
          className="h-auto w-full"
          sizes="(max-width: 768px) 100vw, (max-width: 1024px) 58vw, 55vw"
        />
      </div>
    </div>
  ) : null;
  ...
  const text = (
    <div className={hasThumbnail ? "md:col-span-5 lg:col-span-5" : "w-full"}>
  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-[#141414] pb-12 pt-28 text-white md:pb-16 md:pt-36">
        <div className="relative grid w-full items-center gap-10 pe-3 ps-6 md:grid-cols-2 md:gap-8 md:pe-3 md:ps-0 lg:gap-10">
          <Reveal
            direction="left"
            ...
            <div className="relative min-w-0">
              <div className="relative overflow-hidden bg-[#141414]">
                <Image
                  ...
                  height={900}
                  preload
                  sizes="(max-width: 768px) calc(100vw - 24px), 50vw"
